...
const script = fileURLToPath(new URL('../scripts/verify-signed-webhook-ingress-postgres.mjs', import.meta.url));
...
]) test('signed HTTP verification refuses ' + name + ' before loading Prisma or network calls', () => {
