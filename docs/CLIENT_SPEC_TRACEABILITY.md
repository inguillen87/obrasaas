...
| PRO-12 | Identidad laboral y destino de cobro protegidos | Parcial | El módulo valida CUIL/CBU/CVU/alias, exige consentimiento versionado, cifra con AAD/keyring y serializa enmascarado. Ya existen API tenant-scoped, CAS, idempotencia, separación maker-checker-activator, titular verificado y ledger append-only; sus migraciones se verificaron en Preview aislado y el proveedor bancario falla cerrado hasta una integración confiable | Completar Flow/UI, proveedor de titularidad, opt-in y comprobante privado; nunca ejecutar pagos desde IA/WhatsApp | Piloto H3-H4, S14, R0 |
