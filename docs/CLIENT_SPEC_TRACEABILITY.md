...
| SPEC-AVA-04 | Certificado de avance | Ausente; input técnico S9.1/S9.2 disponible | Existe medición aprobada versionada y corte técnico de obra reproducible; ninguno contiene reglas contractuales, importes, retenciones, impuestos, PDF ni estado de pago | S10 debe crear un artefacto privado, versionado, inmutable y reproducible con autoridad legal/económica propia | S10 |
...
| SPEC-REP-03 | Historial de certificaciones/quincenas | Ausente | S9.2 conserva historial de cortes técnicos por quincena y versión, pero no existe certificación canónica, importe ni PDF contractual | Historial de certificados por período, versión, estado, aprobadores, importe y PDF, sin reutilizar el head técnico como estado contractual | S10 |
...
| SPEC-DEF-03 | Certificación: documento que valida avance para pago | Reformular | No existe certificado; S9.2 fija un corte exclusivamente técnico y la definición original mezcla validación, conformidad y pago | S10 debe separar certificado contractual, conformidad financiera y referencia/estado de pago | S9-S10 |
