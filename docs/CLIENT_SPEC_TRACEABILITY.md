...
S9.1 agrega la [medición técnica cuantitativa](./PROGRESS_MEASUREMENTS_S9_1.md) por tarea y quincena civil. El [corte `46c744c`](./evidence/2026-08-11-preview-46c744c.md) verificó Decimal exacto, evidencia aprobada, maker-checker, replay inmutable, carreras PostgreSQL y Preview rollback-only con 122 migraciones sin drift. El journey UI autenticado todavía está pendiente. S9.1 no reescribe `Task.progress` y no crea certificado, conformidad financiera ni pago; S9.2-MED deberá sellar el corte técnico reproducible antes de S10.
...
| SPEC-PLN-05 | Certificación de avance para quincena | Parcial; medición S9.1 verificada | Existe ledger cuantitativo por tarea/quincena con unidad, base, cantidad ejecutada, evidencia, corrección y maker-checker; no existe certificado contractual | Cerrar journey autenticado, sellar el corte técnico S9.2-MED y después separar certificado, conformidad financiera y referencia de pago | S9-S10 |
...
| SPEC-AVA-04 | Certificado de avance | Ausente; input técnico S9.1 disponible | Existe medición aprobada versionada por tarea/quincena, pero no corte de obra ni certificado contractual | S9.2-MED sella el input técnico; S10 crea el artefacto privado, versionado, inmutable y reproducible con reglas legales propias | S9.2-S10 |
...
| SPEC-DEF-02 | Avance: porcentaje de completitud | Parcial; medición cuantitativa S9.1 verificada | `Task.progress` legacy permanece separado; S9.1 guarda método, cantidad base/ejecutada, período, evidencia, autor y maker-checker, y deriva porcentaje sin mutar la tarea | Recorrer UI autenticada y sellar el corte S9.2-MED; el porcentaje solo no certifica | S5, S9 |
| SPEC-DEF-03 | Certificación: documento que valida avance para pago | Reformular | No existe certificado; S9.1 aporta medición técnica aprobada pero la definición original mezcla validación y pago | S9.2-MED fija el corte técnico; S10 separa certificado contractual, conformidad y referencia de pago | S9-S10 |
...
| PRO-03 | CI, migraciones gobernadas y E2E por rol | Parcial en Preview | El [corte `871cf2f`](./evidence/2026-08-11-preview-871cf2f.md) exige S12.2C y PRO-05A/B.1: CI `31511714114` terminó 3/3 con 121 migraciones, carreras disposable PRO-05B.1, status y drift cero; Vercel/Neon Preview repitió los gates rollback-only y terminó `Ready` con 88/88. El smoke read-only comprobó acceso `ADMIN`, rechazo `AUDITOR` y signed-out 404; no ejecutó POST ni cross-tenant. La [evidencia histórica S12.2C](./evidence/2026-08-11-preview-fc71fbe.md) conserva su recorrido multirrol | Faltan POST maker-checker sintético, matriz completa, cross-tenant y E2E core; ningún gate acredita Production | S0 |
