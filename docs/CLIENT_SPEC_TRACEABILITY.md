...
| PRO-03 | CI, migraciones gobernadas y E2E por rol | Parcial en Preview | El corte `fc71fbe` exige S12.2C y PRO-05A: CI PostgreSQL 17 aprobó 120 migraciones, cuatro carreras disposable, status y drift; Vercel/Neon Preview repitió los verificadores live-safe y terminó `Ready`. Un smoke sintético acotado recorrió `AUDITOR`, `DIRECTOR` y `SITE_MANAGER`, validó boundaries y restauró rol/grant ([evidencia](./evidence/2026-08-11-preview-fc71fbe.md)); no ejecutó una reserva válida ni prueba cross-tenant | Falta matriz completa, cross-tenant y E2E core; ningún gate acredita Production | S0 |
...
| PRO-05 | Retención, DSAR, backup/restore, RPO/RTO y borrado verificable | Parcial en Preview, discovery-only | [PRO-05A](./DATA_SUBJECT_RIGHTS_FOUNDATION.md) agrega caso tenant-scoped, atestación ADMIN distinta de verificar al solicitante, catálogo/read-only discovery, manifiesto inmutable, replay, rate limit y blockers obligatorios; `140000` y su verificador quedaron verdes en PGlite, CI PostgreSQL 17 y Vercel/Neon Preview. V1 sólo puede terminar `DISCOVERY_BLOCKED`: no verifica identidad ni base legal y no exporta, corrige, restringe, ofrece portabilidad, anonimiza o elimina. Faltan PRO-05B/C/D, entidad legal responsable y E2E sintético del endpoint | Gate previo a datos laborales reales; S0, S23 |
