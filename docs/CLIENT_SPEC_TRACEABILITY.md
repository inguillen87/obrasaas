...
financiera, PDF contractual ni pago. La UI dedicada completa de S9.1 y todo S10
...
| SPEC-PLN-05 | Certificación de avance para quincena | Parcial; inputs S9.1/S9.2/S9.3 verificados | Existe ledger cuantitativo por tarea/quincena, corte versionado `MEASURED`/`MISSING` y SOV contractual `VALUED`/`NO_CLAIM` con moneda/minor units, retención y autoridades propias. S9.2 y S9.3 recorrieron maker-checker, replay, roles y aislamiento tenant/obra en Development descartable. Todavía no existe certificado contractual | Implementar S10-CERT, S10-FIN y S10-PAYREF como autoridades append-only distintas; completar aparte la UI dedicada S9.1 | S9.1-S10 |
...
| SPEC-REP-03 | Historial de certificaciones/quincenas | Ausente | S9.2 conserva historial de cortes técnicos por quincena/versión y S9.3 conserva versiones/decisiones de la SOV contractual. No existe certificación canónica ni PDF contractual | Historial de certificados por período, cut exacto, versión SOV, decisiones, importe y PDF, sin reutilizar el head técnico, `BudgetVersion` o `SupplierInvoice` | S10 |
...
| SPEC-DEF-03 | Certificación: documento que valida avance para pago | Reformular | No existe certificado. S9.2 fija un corte técnico y S9.3 una base contractual aprobable aparte; la definición original mezcla certificado, conformidad y pago | Dividir S10 en certificado contractual, conformidad financiera y referencia externa append-only. Ninguna fase crea `PAID` ni prueba pago | S10 |
