...
| PRO-05 | Retención, DSAR, backup/restore, RPO/RTO y borrado verificable | Ausente | La purga acotada de claims o sesiones no constituye un DSAR integral. La constancia H4 limita el acceso a 15 minutos y no almacena el PDF, pero su expiración no elimina el registro mínimo; faltan matriz de retención, cobertura de media/mensajes/identidad/derivados/backups y restore drill comprobado | Gate previo a datos laborales reales; S0, S23 |
