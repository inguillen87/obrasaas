...
| --- | --- |
| WIP local | La rama contiene 108 migraciones versionadas. Las cinco H4 `13000-13400`, incluida la constancia privada, tienen evidencia local completa: 1.775/1.775 pruebas, `prisma validate`, Prisma Client generado, lint y build verdes; las 108 migraciones y el verificador semántico pasan desde cero en PGlite descartable. Esto no reemplaza PostgreSQL real/Neon Preview ni los smokes Vercel/Meta |
