...
El símbolo une dos mitades de un mismo circuito:

- La base naranja representa la obra, el terreno y la ejecución.
- La estructura clara u oscura representa gestión, criterio y control.
- Ambas forman una `O` continua: la información sube desde el campo y las decisiones vuelven a la obra.
- Las uniones desplazadas evitan un sello estático y sugieren movimiento, sincronización y trazabilidad.
...
- Tamaño mínimo recomendado del símbolo digital: `16 px`.
...
- Para favicons, launchers, perfiles y avatares institucionales: usar el app icon.
...
- No cambiar la relación entre las dos mitades.
