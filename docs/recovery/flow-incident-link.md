...
## Cierre combinado A29/A30
El candidato de cierre incluye la invalidaci?n de lecturas al reconectar y la prueba de arranque `flow-history-postgres-bootstrap.test.js`. La suite SQL importa el verificador de incidencias despu?s de registrar aliases, igual que el de asistencia. No se cambiaron las guardas de acceso a la base. Los resultados de compilaci?n, PostgreSQL y sesi?n real se registran por el nuevo SHA en PR #1.
