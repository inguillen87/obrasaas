...
“Cubierto” describe la evidencia indicada, no equivale automáticamente a journey UI ni E2E externo. El corte base de esta revisión es 29 de julio de 2026; las filas con evidencia posterior la fechan explícitamente. Se distingue código/pruebas locales, migración aislada en Preview, journey UI y proveedor externo real.
