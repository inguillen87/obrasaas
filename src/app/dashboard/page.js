...
import DirectorRoleView from './components/roles/DirectorRoleView';
          ...
          <section id="sec-dashboard" className={`content-section animate-fade-in-up ${activeTab === 'sec-dashboard' ? 'active' : ''}`}>
            {selectedPersona === 'directora' && (
              <DirectorRoleView
                ...
                sendCopilotUserMessage={sendCopilotUserMessage}
                copilotMessagesEndRef={copilotMessagesEndRef}
                handleAgenticAction={handleAgenticAction}
                setShowForensicCertModal={setShowForensicCertModal}
                setShowWeeklyReportModal={setShowWeeklyReportModal}
                addToast={addToast}
              />
            )}

            {selectedPersona === 'compras' && (
              <ComprasRoleView
                state={state}
