...
export default function AssignmentPlanner({organizationId,projectId,tasks,focusedTask,onClose,onSaved}) {
  ...
  const [review,setReview]=useState(null),[coordination,setCoordination]=useState(''),[reviewEpoch,setReviewEpoch]=useState(0);
