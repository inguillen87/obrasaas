...
export default function BimDigitalTwinPage() {
    ...
    const [mobilePanel, setMobilePanel] = useState('3d'); // '3d' | 'layers' | 'inspector'
            ...
            <header style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        ...
                        <div>
                            <h1 style={{ fontSize: 'clamp(0.8rem, 2.5vw, 0.9rem)', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.04em', margin: 0, color: '#fff', fontFamily: tokens.font.heading }}>
                                Visor 3D BIM & Gemelo Digital
                            </h1>
                            <p style={{ fontSize: '0.7rem', color: '#94a3b8', margin: 0 }}>
                                Torre Palermo Soho • IFC v4.3
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    <button
                        ...
                        style={{
                            ...
                            padding: '8px',
                            borderRadius: '8px',
                            border: mobilePanel === '3d' ? '1px solid #f59e0b' : 'none',
                            background: mobilePanel === '3d' ? 'rgba(245, 158, 11, 0.15)' : 'transparent',
                            color: mobilePanel === '3d' ? '#fbbf24' : '#94a3b8',
                            fontSize: '0.78rem',
                            fontWeight: 700,
                            cursor: 'pointer'
                        }}
                    ...
                    <button
                        ...
                        style={{
                            ...
                            padding: '8px',
                            borderRadius: '8px',
                            border: mobilePanel === 'layers' ? '1px solid #6366f1' : 'none',
                            background: mobilePanel === 'layers' ? 'rgba(99, 102, 241, 0.15)' : 'transparent',
                            color: mobilePanel === 'layers' ? '#a5b4fc' : '#94a3b8',
                            fontSize: '0.78rem',
                            fontWeight: 700,
                            cursor: 'pointer'
                        }}
                    ...
                    <button
                        ...
                        style={{
                            ...
                            padding: '8px',
                            borderRadius: '8px',
                            border: mobilePanel === 'inspector' ? '1px solid #10b981' : 'none',
                            background: mobilePanel === 'inspector' ? 'rgba(16, 185, 129, 0.15)' : 'transparent',
                            color: mobilePanel === 'inspector' ? '#6ee7b7' : '#94a3b8',
                            fontSize: '0.78rem',
                            fontWeight: 700,
                            cursor: 'pointer'
                        }}
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            ...
                            <div style={{
                                ...
                                <span style={{ fontWeight: 800, color: '#f8fafc', fontSize: '0.72rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                                    Convención Visual
                                </span>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    <span style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#10b981', display: 'inline-block' }} />
                                    <span style={{ color: '#cbd5e1' }}>100% Conforme / Aprobado</span>
                                </div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <div style={{ fontSize: '0.72rem', color: '#64748b', textAlign: 'center', borderTop: '1px solid rgba(255, 255, 255, 0.08)', paddingTop: '12px', marginTop: '16px', fontWeight: 600 }}>
                            {isMobile ? 'Tocá o deslizá con el dedo para interactuar 🔄' : 'Arrastrá con el mouse para rotar el edificio en 3D 🔄'}
                        </div>
                    </div>
                )}
