...
export function createProjectContractAuthorityHandlers({
  ...
  propose = proposeProjectContractAuthority,
    ...
    async POST(request) {
      try {
        ...
        return knownProjectContractError(request, error)
          || unexpectedProjectContractError(request, error, 'authority.propose', logError);
      }
    },
  };
}
